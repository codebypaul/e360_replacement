...
class EquipmentAdmin(admin.ModelAdmin):
    ...
    list_display = ['equipment_id','status','serial_number','year','description','hours','contract','location']

class VehicleAdmin(admin.ModelAdmin):
    # list_display = [field.name for field in Vehicle._meta.get_fields()]
    list_display = ['equipment_id','status','vin','year','description','mileage','contract','driver']
